...
public class GameClockServiceImpl implements GameClockService {
    ...
    public void updateClock() throws IOException {
        ...
        for(String gameStateId : activeGameIds) {
            ...
            if(!gameState.getPlayer1().isOnline() || !gameState.getPlayer2().isOnline()) {
...
//            gameState.getPlayer1().notifyGameEvent(gameState);
//            gameState.getPlayer2().notifyGameEvent(gameState);
